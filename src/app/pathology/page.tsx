        ...
        <AnimatePresence mode="wait">
                  ...
                  <div className="flex-1 min-h-[220px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={weeklyData}>
                        ...
                        <RechartsTooltip cursor={{ fill: 'rgba(255,255,255,0.03)' }} contentStyle={{ background: "rgba(3, 7, 5, 0.95)", border: "1px solid rgba(0, 255, 157, 0.15)", borderRadius: "12px", color: "#e8efe8", fontFamily: "var(--font-mono)" }} />
            ...
            <motion.div key="aerial" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }} className="space-y-6">
              ...
              <div className="flex justify-between items-center border-b border-white/10 pb-4">
                <div className="flex gap-2">
                  ...
                  >
                    <Plane className="w-3.5 h-3.5" /> Spectral Scan & Analysis
                  </button>
                  <button 
              ...
              {aerialSubTab === "scan" ? (
                <>
                    ...
                    <div className="lg:col-span-5 glass-card p-6 flex flex-col rounded-2xl">
                      ...
                      >
                        ...
                        {primaryPreview ? (
                          ...
                          <div className="flex flex-col items-center justify-center text-center p-4">
                            ...
                            <span className="text-xs font-mono mb-1" style={{ color: "rgba(232, 239, 232, 0.7)" }}>Click or drag & drop aerial scan</span>
                      ...
                      <div className="flex gap-3 mt-auto pt-2">
                        ...
                        >
                          {isProcessingUav ? (
                            <>
                              <RefreshCw className="w-4 h-4 animate-spin" /> Computing {indexType}...
                            </>
                          ) : (
                            <>
                              <Sparkles className="w-4 h-4" /> Run {indexType} Analysis
                            </>
                          )}
                        </button>
                      ...
                      <div className="flex justify-between items-center mb-4">
                        <h2 className="text-sm font-mono text-white font-medium flex items-center gap-2">
                          <span className="w-5 h-5 rounded-full text-[10px] flex items-center justify-center font-bold"
                            style={{ background: "rgba(0, 229, 255, 0.15)", color: "#00E5FF" }}
                          >2</span>
                          {uavResult ? `${uavResult.index_type} Canopy Health Map` : "Canopy Spectral Visualizer"}
                        </h2>
                      ...
                      {!uavResult ? (
                        ...
                        >
                          ...
                          <p className="text-xs font-mono max-w-sm" style={{ color: "rgba(232, 239, 232, 0.3)" }}>
                            Upload an aerial drone scan or click &apos;Load Sample&apos; to extract ExG canopy segmentation and physiological anomalies.
                          </p>
                        </div>
                      ) : (
                        <div className="flex-1 flex flex-col">
                          ...
                          >
                            <div className="flex justify-between text-[11px] font-mono mb-1.5" style={{ color: "rgba(232, 239, 232, 0.5)" }}>
                              <span style={{ color: "#FF4C4C" }}>🔴 Severe Decay ({uavResult.index_type === "NDVI" ? "< 0.40" : "< 0.02"})</span>
                              <span style={{ color: "#E6AF2E" }}>🟡 Moderate Chlorosis ({uavResult.index_type === "NDVI" ? "0.40 - 0.60" : "0.02 - 0.15"})</span>
                              <span style={{ color: "#00FF9D" }}>🟢 Vigorous Canopy ({uavResult.index_type === "NDVI" ? "> 0.60" : "> 0.15"})</span>
                            </div>
                  ...
                  {uavResult && (
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                      ...
                      <div className="glass-card p-4 rounded-xl">
                        <div className="text-[10px] font-mono uppercase tracking-wider" style={{ color: "rgba(232, 239, 232, 0.4)" }}>CANOPY VS GROUND</div>
                      ...
                      <div className="glass-card p-4 rounded-xl">
                        <div className="text-[10px] font-mono uppercase tracking-wider" style={{ color: "rgba(232, 239, 232, 0.4)" }}>FLAGGED ANOMALIES</div>
                        <div className="text-2xl font-light mt-1 font-mono" style={{ color: "#FF4C4C" }}>{uavResult.hotspots?.length || 0} Trees</div>
                        <div className="text-[10px] font-mono mt-1" style={{ color: "rgba(232, 239, 232, 0.4)" }}>Z-Score Biological Outliers</div>
                      </div>
                    </motion.div>
                  )}
                        ...
                        <table className="w-full text-left">
                          <thead>
                            ...
                            >
                              ...
                              <th className="p-3">Index Score</th>
                              <th className="p-3">Z-Score / Drop</th>
                              <th className="p-3">Affected Radius</th>
                              <th className="p-3">Pathological Recommendation</th>
                ...
                <div className="glass-card p-6 rounded-2xl space-y-4">
                  <div className="flex justify-between items-center">
                    <h3 className="text-sm font-mono text-white font-medium flex items-center gap-2">
                      <FileText className="w-4 h-4" style={{ color: "#00E5FF" }} /> Historical UAV Orthomosaic Flights
                    </h3>
                    <span className="text-xs font-mono" style={{ color: "rgba(232, 239, 232, 0.4)" }}>{HISTORICAL_AERIAL_SURVEYS.length} Surveys Logged</span>
                  </div>
                    ...
                    <table className="w-full text-left">
                      <thead>
                        <tr className="border-b text-[10px] uppercase font-mono"
                          style={{ borderColor: "rgba(255, 255, 255, 0.08)", color: "rgba(232, 239, 232, 0.4)", background: "rgba(0,0,0,0.2)" }}
                        >
                          <th className="p-3.5">Survey ID / Date</th>
                          <th className="p-3.5">Estate Location</th>
                          <th className="p-3.5">Spectral Mode</th>
                          <th className="p-3.5">Mean Index</th>
                          <th className="p-3.5">Canopy Purity</th>
                          <th className="p-3.5">Detected Palms</th>
                          <th className="p-3.5">Flagged Outliers</th>
            ...
            <motion.div key="mobile" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }} className="space-y-6">
              ...
              <div className="flex justify-between items-center border-b border-white/10 pb-4">
                <div className="flex gap-2">
                  ...
                  >
                    <Microscope className="w-3.5 h-3.5" /> Leaf & Trunk Inference
                  </button>
                  <button 
                  ...
                  >
                    <FileText className="w-3.5 h-3.5" /> Recent Leaf Scans ({DEMO_DIAGNOSTICS.length})
                  </button>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] font-mono px-2 py-1 rounded" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", color: "rgba(232,239,232,0.5)" }}>
                      OOD Gating: Shannon Entropy (H_th = 2.10 bits)
                    </span>
                    {syncStatus === "synced" && (
              ...
              {mobileSubTab === "scan" ? (
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                  ...
                  <div className="lg:col-span-5 glass-card p-6 flex flex-col min-h-[480px] rounded-2xl">
                    <h2 className="text-sm font-mono text-white font-medium mb-1">Leaf & Trunk Close-up Scan</h2>
                    <p className="text-xs mb-4 font-mono" style={{ color: "rgba(232, 239, 232, 0.4)" }}>
                      Upload or capture a suspected lesion for instant on-device MobileNetV2-INT8 classification.
                    </p>
                    ...
                    >
                      ...
                      {mobilePreview ? (
                        <div className="relative w-full h-full p-2">
                          ...
                          {isAnalyzingMobile && (
                            <div className="absolute inset-0 bg-black/70 backdrop-blur-sm rounded-xl flex flex-col items-center justify-center">
                              ...
                              <p className="text-xs font-mono" style={{ color: "#FF8C00" }}>Computing INT8 Tensors...</p>
                            </div>
                          )}
                        </div>
                      ) : (
                        <div className="flex flex-col items-center justify-center p-6 text-center">
                          ...
                          <span className="text-xs font-mono mb-1" style={{ color: "rgba(232, 239, 232, 0.8)" }}>Click or drag & drop lesion photo</span>
                          <span className="text-[10px] font-mono" style={{ color: "rgba(232, 239, 232, 0.4)" }}>Supports Bud Rot, Leaf Rot, Gray Spot, Stem Bleeding</span>
                        </div>
                      )}
                    </label>
                    ...
                    <div className="mt-4 flex justify-end">
                      ...
                      >
                        <Sparkles className="w-4 h-4" /> Run Edge Inference
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="lg:col-span-7 glass-card p-6 min-h-[480px] flex flex-col rounded-2xl">
                    <h2 className="text-sm font-mono text-white font-medium mb-4 flex items-center justify-between">
                      ...
                      {mobileResult && !mobileResult.error && (
                        <span className="text-[10px] font-mono" style={{ color: "rgba(232, 239, 232, 0.4)" }}>
                          Latency: {mobileResult.inference_time_ms?.toFixed(0)}ms
                        </span>
                      )}
                    </h2>
                    ...
                    {mobileResult ? (
                      mobileResult.error ? (
                        ...
                        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-5 flex-1">
                          ...
                          <div className="p-4 rounded-xl border" style={{ background: "rgba(0, 0, 0, 0.3)", borderColor: "rgba(255, 255, 255, 0.08)" }}>
                            <div className="flex justify-between items-start mb-3">
                              ...
                              <span className="text-xs font-mono font-bold" style={{ color: "#00FF9D" }}>
                                {(mobileResult.confidence * 100).toFixed(1)}% Match
                              </span>
                            </div>
                          ...
                          {mobileResult.all_predictions && (
                            <div className="p-4 rounded-xl border" style={{ background: "rgba(0, 0, 0, 0.3)", borderColor: "rgba(255, 255, 255, 0.08)" }}>
                              <h4 className="text-[11px] font-mono uppercase mb-3" style={{ color: "rgba(232, 239, 232, 0.4)" }}>Class Distribution:</h4>
                              <div className="space-y-2">
                                {mobileResult.all_predictions.map((p: any) => (
                                  <div key={p.class} className="flex items-center gap-3 text-xs font-mono">
                                    <span className="w-36 truncate capitalize" style={{ color: "rgba(232, 239, 232, 0.6)" }}>{p.class}</span>
                          ...
                          {mobileResult.knowledge && (
                            <div className="space-y-3">
                              <h4 className="text-[11px] font-mono uppercase" style={{ color: "rgba(232, 239, 232, 0.4)" }}>CRI Treatment Protocols:</h4>
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div className="p-3 rounded-xl border" style={{ background: "rgba(255, 76, 76, 0.05)", borderColor: "rgba(255, 76, 76, 0.2)" }}>
                                  <span className="text-[10px] font-mono font-bold block mb-1" style={{ color: "#FF4C4C" }}>CHEMICAL ACTION</span>
                                  <p className="text-xs font-mono" style={{ color: "rgba(232, 239, 232, 0.7)" }}>{mobileResult.knowledge.treatment_protocols.chemical[0]}</p>
                                </div>
                                <div className="p-3 rounded-xl border" style={{ background: "rgba(0, 255, 157, 0.05)", borderColor: "rgba(0, 255, 157, 0.2)" }}>
                                  <span className="text-[10px] font-mono font-bold block mb-1" style={{ color: "#00FF9D" }}>CULTURAL MEASURE</span>
                                  <p className="text-xs font-mono" style={{ color: "rgba(232, 239, 232, 0.7)" }}>{mobileResult.knowledge.treatment_protocols.cultural[0]}</p>
                                </div>
                              </div>
                            </div>
                          )}
                          ...
                          <div className="pt-2">
                            ...
                            >
                              ...
                              <span>View Full CRI Treatment Guide for {mobileResult.disease} in Knowledge Base →</span>
                            </button>
                          </div>
                      ...
                      >
                        ...
                        <p className="text-xs font-mono">Upload a leaf or trunk lesion to see AI classification</p>
                      </div>
                    )}
                  </div>
                ...
                <div className="glass-card p-6 rounded-2xl space-y-4">
                  <div className="flex justify-between items-center">
                    <h3 className="text-sm font-mono text-white font-medium flex items-center gap-2">
                      <Smartphone className="w-4 h-4" style={{ color: "#FF4C4C" }} /> Recent Microscopic Leaf Diagnostics
                    </h3>
                    <span className="text-xs font-mono" style={{ color: "rgba(232, 239, 232, 0.4)" }}>{DEMO_DIAGNOSTICS.length} Diagnostics Logged</span>
                  </div>
                    ...
                    <table className="w-full text-left">
                      <thead>
                        <tr className="border-b text-[10px] uppercase font-mono"
                          style={{ borderColor: "rgba(255, 255, 255, 0.08)", color: "rgba(232, 239, 232, 0.4)", background: "rgba(0,0,0,0.2)" }}
                        >
                          <th className="p-3.5">Diagnostic ID / Date</th>
                          <th className="p-3.5">Pathogen Class</th>
                          <th className="p-3.5">Inference Confidence</th>
                          <th className="p-3.5">GPS Location</th>
                          <th className="p-3.5 text-right">Protocol Action</th>
                        </tr>
                      </thead>
                      <tbody>
            ...
            <motion.div key="knowledge" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }} className="space-y-6">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="text-xs font-mono" style={{ color: "rgba(232, 239, 232, 0.5)" }}>
                  Showing {filteredKnowledge.length} Official CRI Protocols
                </div>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex justify-between items-start">
                        <div>
                          <div className="flex items-center gap-3">
                            <h3 className="text-base font-medium text-white">{item.common_name}</h3>
                        ...
                        <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} className="mt-6 pt-6 border-t space-y-6" style={{ borderColor: "rgba(255, 255, 255, 0.08)" }}>
                            ...
                            <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
                              {item.symptoms.map((s, i) => (
                                <li key={i} className="text-xs font-mono flex items-start gap-2 p-2.5 rounded-lg border"
                                  style={{ background: "rgba(0, 0, 0, 0.2)", borderColor: "rgba(255, 255, 255, 0.05)", color: "rgba(232, 239, 232, 0.7)" }}
                                >
                          ...
                          <div>
                            <h4 className="text-xs font-mono uppercase tracking-wider mb-2 flex items-center gap-1.5" style={{ color: "#00FF9D" }}>
                              <ShieldCheck className="w-3.5 h-3.5" /> Integrated Management Protocol:
                            </h4>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                              <div className="p-3.5 rounded-xl border" style={{ background: "rgba(255, 76, 76, 0.05)", borderColor: "rgba(255, 76, 76, 0.2)" }}>
                                <span className="text-[10px] font-mono font-bold block mb-1.5" style={{ color: "#FF4C4C" }}>CHEMICAL</span>
                                <ul className="text-xs font-mono space-y-1" style={{ color: "rgba(232, 239, 232, 0.7)" }}>
                                  {item.treatment_protocols.chemical.map((c, i) => <li key={i}>• {c}</li>)}
                                </ul>
                              </div>
                              <div className="p-3.5 rounded-xl border" style={{ background: "rgba(0, 255, 157, 0.05)", borderColor: "rgba(0, 255, 157, 0.2)" }}>
                                <span className="text-[10px] font-mono font-bold block mb-1.5" style={{ color: "#00FF9D" }}>CULTURAL</span>
                                <ul className="text-xs font-mono space-y-1" style={{ color: "rgba(232, 239, 232, 0.7)" }}>
                                  {item.treatment_protocols.cultural.map((c, i) => <li key={i}>• {c}</li>)}
                                </ul>
                              </div>
                              <div className="p-3.5 rounded-xl border" style={{ background: "rgba(167, 139, 250, 0.05)", borderColor: "rgba(167, 139, 250, 0.2)" }}>
                                <span className="text-[10px] font-mono font-bold block mb-1.5" style={{ color: "#A78BFA" }}>BIOLOGICAL</span>
                                <ul className="text-xs font-mono space-y-1" style={{ color: "rgba(232, 239, 232, 0.7)" }}>
                                  {item.treatment_protocols.biological.map((b, i) => <li key={i}>• {b}</li>)}
                                </ul>
                              </div>
                            </div>
                          </div>
                          ...
                          >
                            ...
                            <span><strong>CRI Field Note:</strong> {item.vernacular_advice}</span>
                          </div>
          ...
          {tab === "history" && (
            <motion.div key="history" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }} className="space-y-6">
              ...
              <div className="flex justify-between items-center mb-2">
                <div className="flex items-center gap-3">
                  <span className="text-xs font-mono uppercase" style={{ color: "rgba(232, 239, 232, 0.5)" }}>Filter:</span>
                  <select 
                    value={filterDisease} 
                  ...
                  <table className="w-full text-left">
                    <thead>
                      ...
                      >
                        ...
                        <th className="p-4">Pathogen Classification</th>
                        <th className="p-4">Inference Confidence</th>
